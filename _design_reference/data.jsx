...
const TODAY = new Date(2026, 4, 15); // month is 0-indexed → May = 4

const COMPANIES = ['הראל', 'מגדל', 'אלטשולר שחם', 'כלל', 'מנורה מבטחים', 'הפניקס', 'מיטב דש'];
const CATEGORIES = ['בריאות', 'חיים/משכנתא', 'פנסיה', 'השקעות'];
...
function isJoiningAnniversary(iso) {
  const d = new Date(iso);
...
Object.assign(window, {
  TODAY, COMPANIES, CATEGORIES, SAMPLE_CLIENTS, STATUS_LABELS,
  fmtDate, fmtDateLong, fmtCurrency, initials, ageFromDob, yearsSince,
  isBirthdayToday, isJoiningAnniversary, daysUntilBirthday,
});
